    ...
    <div className="flex flex-col p-10 bg-[#2AD300]  h-5/6">
      <div className="flex gap-x-10 self-center h-4/5 mt-8 w-full  max-md:flex-wrap max-md:max-w-full mb-10">
        <div className="flex flex-col w-1/4 self-start mt-6 text-5xl font-medium tracking-tighter leading-9 text-white whitespace-nowrap max-md:text-3xl mr-16">
          <a href="/" className="">SolarCompass</a>
          <img
            loading="lazy"
          ...
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-3/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col text-sm font-medium text-neutral-800 max-md:mt-10">
                <a href="/about" className=" py-4">About us</a>
                <a href="/locations" className=" py-4">Ogecy locations</a>
                <a href="/ceo" className=" py-4">Ceos message</a>
              </div>
            </div>
            <div className="flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col text-sm font-medium text-neutral-800 max-md:mt-10">
                <a href="/freight" className=" py-4">Freight Logistics</a>
                <a href="/events" className=" py-4">Event Logistics</a>
                <a href="/warehousing" className=" py-4">Warehousing and other</a>
                <a href="/insurance" className=" py-4">Insurance Services</a>
              </div>
            </div>
            <div className="flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow text-sm font-medium text-neutral-800 max-md:mt-10">
                <a href="/contact" className=" py-4">Contact us</a>
                <a href="/address" className=" py-4">Copy address to clipboard</a>
                <a href="/maps" className=" py-4">google maps riyadh</a>
                <a href="/pallet-size" className= "py-4">pallet size refernce</a>
                <a href="/country-code" className=" py-4">country code reference</a>
                <a href="/airport-code" className=" py-4">airport code reference</a>
              </div>
            </div>
            <div className="flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full">
